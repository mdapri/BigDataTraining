...
.content-fragment.captcha-blog-post-comment-form .internal-link.add-reply:hover {background: #9d3602;}
...
a.sidebar-tile-home {
  background: #d14600 url(http://blogs.technet.com/cfs-filesystemfile.ashx/__key/communityserver-blogs-components-weblogfiles/00-00-00-94-25/5417.home.png) 50% 50% no-repeat;
}
...
a.sidebar-tile-contact {
  background: #d14600 url(http://blogs.technet.com/cfs-filesystemfile.ashx/__key/communityserver-blogs-components-weblogfiles/00-00-00-94-25/5340.icon_2D00_email_2D00_large.png) 50% 50% no-repeat;
}
...
/* Begin STB header */
	...
	/* Begin global STB header */
		...
		#stb-header a h2 {font: 100 3em/*36px*//1.166/*42px*/ 'Segoe UI Light','Segoe UI','Lucida Grande',Verdana,Arial,Helvetica,sans-serif; margin: 11px 0 20px; color: #d14600; position: relative; top: 3px;}
	...
	/* Begin STB Tier 3 header */
		.stb-nav {background: #d14600;}		
		.stb-nav > li > a.menu-title:hover, .stb-nav .stb-nav-drop, .stb-nav > li > a.menu-title.expanded {background: #9d3602;}
		.menu-title.expanded {.field_wrapper:after { content: "."; display: block; height: 0; clear: both; visibility: hidden; }}
		.stb-nav-drop > li > a:hover, .stb-nav > li > a.menu-title {background: #d14600;}
		.stb-nav-drop a {border-left: 0 !important;}
		.description-container .description  h2, .content-fragment.with-header .content-fragment-header div, .content-fragment.link-list .content-list-name {color: #d14600;}
    .content-fragment.with-header .content-fragment-header div a {color: #d14600; font-weight: bold;}
...
/* Begin tabs and container for sxp */
	...
	#sxp-tabs {margin: 0 0 30px; width: 718px; background: #d14600; height: 32px; padding: 0 !important; border-bottom: solid 1px #ccc; font-size: 1.167em;}
	#sxp-tabs li {list-style-type: none; height: 32px; position: relative; float: left; border: solid #CCC; border-width: 0 1px 1px 0;}
	#sxp-tabs a {color: #fff; background: #d14600; height: 100%; line-height: 34px; padding: 0 20px; display: block; margin-left: 0;}
	#sxp-tabs a:hover {text-decoration: none;}
	#sxp-tabs a:first-child + a {left: -3px;}
	#sxp-tabs a:hover {background: #9d3602;}
	#sxp-tabs .selected {margin-top: -4px; height: 36px;}
	#sxp-tabs .selected a, #sxp-tabs .selected a:hover {background: #9d3602;}
